...
public class enemyWaveState : MonoBehaviour
{
    ...
    public enum waveState {first,second,third};
    ...
    public void SpawnWave(params int[] indices)
    {
        ...
        {
            Instantiate(Choose(enemyRunner, enemyTurret), spawnPoints[indices[j] - 1], transform.rotation);
        }
